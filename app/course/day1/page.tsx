...
export default function Day1Page() {
  ...
  const completeStep = (step: string) => {
    ...
    if (step === "step1") setCurrentStep("step2_1")
    else if (step === "step2_1") setCurrentStep("step2_2")
    else if (step === "step2_2") setCurrentStep("step2_3")
    else if (step === "step2_3") setCurrentStep("step2_4")
    else if (step === "step2_4") setCurrentStep("step2_5")
    else if (step === "step2_5") setCurrentStep("step3_1")
    else if (step === "step3_1") setCurrentStep("step3_2")

    setTimeout(() => {
      const stepElement = document.getElementById(step === "step3_2" ? "final-tips" : currentStep)
      if (stepElement) {
            ...
            <Card className="max-h-[calc(100vh-8rem)] overflow-y-auto">
              ...
              <CardContent className="pt-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <h3 className="font-medium">진행 단계</h3>
                    <div className="space-y-2">
                      <div className={`flex items-center ${currentStep === "step1" ? "bg-pink-50 rounded-md p-2" : ""}`}>
                        {completedSteps.step1 ? (
                          <CheckCircle className="h-4 w-4 text-green-600 mr-2" />
                        ) : (
                          <div
                            className={`w-4 h-4 rounded-full mr-2 ${
                              currentStep === "step1" ? "bg-pink-600" : "bg-gray-200"
                            }`}
                          />
                        )}
                        <span
                          className={`text-sm ${
                            completedSteps.step1 ? "text-green-600" : currentStep === "step1" ? "font-medium" : ""
                          }`}
                        >
                          네이버 블로그 개설
                        </span>
                      ...
                      <div
                        className={`flex items-center ${
                          currentStep.startsWith("step2_") ? "bg-pink-50 rounded-md p-2" : ""
                        }`}
                      >
                        {completedSteps.step2_5 ? (
                          <CheckCircle className="h-4 w-4 text-green-600 mr-2" />
                        ) : (
                          <div
                            className={`w-4 h-4 rounded-full mr-2 ${
                              currentStep.startsWith("step2_") ? "bg-pink-600" : "bg-gray-200"
                            }`}
                          />
                        )}
                        <span
                          className={`text-sm ${
                            completedSteps.step2_5 ? "text-green-600" : currentStep.startsWith("step2_") ? "font-medium" : ""
                          }`}
                        >
                          프로필 설정
                        </span>
                      ...
                      <div
                        className={`flex items-center ${
                          currentStep.startsWith("step3_") ? "bg-pink-50 rounded-md p-2" : ""
                        }`}
                      >
                        {completedSteps.step3_2 ? (
                          <CheckCircle className="h-4 w-4 text-green-600 mr-2" />
                        ) : (
                          <div
                            className={`w-4 h-4 rounded-full mr-2 ${
                              currentStep.startsWith("step3_") ? "bg-pink-600" : "bg-gray-200"
                            }`}
                          />
                        )}
                        <span
                          className={`text-sm ${
                            completedSteps.step3_2 ? "text-green-600" : currentStep.startsWith("step3_") ? "font-medium" : ""
                          }`}
                        >
                          카테고리 구성
                        </span>
            ...
            <TabsContent value="learn" className="mt-0">
              <Card className="border-none shadow-md">
                ...
                <CardContent className="pt-6 space-y-8">
                  ...
                  <div
                    id="step1"
                    className={`bg-gray-50 rounded-lg p-6 ${currentStep !== "step1" && completedSteps.step1 ? "opacity-70" : ""}`}
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      {currentStep === "step1" && (
                        <div className="flex justify-end mt-4">
                          <Button onClick={() => completeStep("step1")} className="bg-pink-600 hover:bg-pink-700">
                            완료 및 계속하기
                  ...
                  {/* Step 2-1: 프로필 설정 - 기본 설정 */}
                  {(currentStep === "step2_1" || completedSteps.step2_1) && (
                    <div
                      id="step2_1"
                      className={`bg-gray-50 rounded-lg p-6 ${
                        currentStep !== "step2_1" && completedSteps.step2_1 ? "opacity-70" : ""
                      }`}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-medium">Step 2-1: 프로필 기본 설정</h3>
                        {completedSteps.step2_1 && (
                          <Badge variant="outline" className="bg-green-50 text-green-600 border-green-200">
                            완료
                          </Badge>
                        )}
                      ...
                      <div className="space-y-4">
                        <div className="bg-white rounded-lg p-4 shadow-sm">
                          ...
                          <p className="text-sm text-gray-600 mt-2">
                            관리 {`>`} 기본설정 {`>`} 기본 정보관리 {`>`} 블로그 정보에서 설정할 수 있습니다.
                          </p>
                        </div>
                  ...
                  {/* Step 2-2: 프로필 설정 - 블로그 주제 선정 */}
                  {(currentStep === "step2_2" || completedSteps.step2_2) && (
                    <div
                      id="step2_2"
                      className={`bg-gray-50 rounded-lg p-6 ${
                        currentStep !== "step2_2" && completedSteps.step2_2 ? "opacity-70" : ""
                      }`}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-medium">Step 2-2: 블로그 주제 선정</h3>
                        {completedSteps.step2_2 && (
                          <Badge variant="outline" className="bg-green-50 text-green-600 border-green-200">
                            완료
                          </Badge>
                        )}
                      ...
                      <div className="space-y-4">
                          ...
                          <div className="mt-3 space-y-2">
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                <p className="text-gray-600">
                                  관심도가 높은 주제를 선정하여 지속적인 컨텐츠 제작이 가능하도록 합니다.
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="bg-yellow-50 p-3 rounded-lg mt-4">
                              ...
                              <ul className="mt-2 space-y-2 text-sm text-gray-600">
                                <li>
                                  • <span className="text-primary font-medium">하나의 주력 카테고리</span>를 정하고 전문성을 키우세요.
                                </li>
                                <li>
                                  • 선택한 카테고리에서 <span className="text-primary font-medium">꾸준히 양질의 콘텐츠</span>를 제작하세요.
                                </li>
                                <li>• 사진, 글쓰기 등 콘텐츠 제작 능력을 향상시키세요.</li>
                                <li>• 댓글 소통과 이웃 맺기로 커뮤니티를 형성하세요.</li>
                                <li>
                                  • 체험단 주최측은 <span className="text-primary font-medium">제품을 잘 설명할 수 있는 블로거</span>를 선호합니다.
                                </li>
                                <li>
                                  • 블로그 주제와 제목을 체험하고 싶은 분야와 연관되게 설정하면 선정 확률이 높아집니다.
                                </li>
                        ...
                        <div className="bg-white rounded-lg p-4 shadow-sm">
                          <h4 className="font-medium text-gray-800">블로그 주제 예시</h4>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              <div className="bg-gray-50 p-4 rounded-lg">
                                ...
                                <ul className="text-sm text-gray-600 space-y-1">
                                  <li>
                                    • <span className="text-primary">체험단 당첨률 높음</span> / 협찬 기회 많음
                                  </li>
                                  <li>• 스킨케어, 메이크업 제품</li>
                                  <li>• 신제품 리뷰 기회 많음</li>
                                </ul>
                  ...
                  {/* Step 2-3: 프로필 설정 - 블로그 제목과 닉네임 */}
                  {(currentStep === "step2_3" || completedSteps.step2_3) && (
                    <div
                      id="step2_3"
                      className={`bg-gray-50 rounded-lg p-6 ${
                        currentStep !== "step2_3" && completedSteps.step2_3 ? "opacity-70" : ""
                      }`}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-medium">Step 2-3: 블로그 제목과 닉네임 설정</h3>
                        {completedSteps.step2_3 && (
                          <Badge variant="outline" className="bg-green-50 text-green-600 border-green-200">
                            완료
                          </Badge>
                        )}
                  ...
                  {/* Step 2-4: 프로필 설정 - 프로필 이미지 */}
                  {(currentStep === "step2_4" || completedSteps.step2_4) && (
                    <div
                      id="step2_4"
                      className={`bg-gray-50 rounded-lg p-6 ${
                        currentStep !== "step2_4" && completedSteps.step2_4 ? "opacity-70" : ""
                      }`}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-medium">Step 2-4: 프로필 이미지</h3>
                        {completedSteps.step2_4 && (
                          <Badge variant="outline" className="bg-green-50 text-green-600 border-green-200">
                            완료
                          </Badge>
                        )}
                  ...
                  {/* Step 2-5: 프로필 설정 - 프로필 완성하기 */}
                  {(currentStep === "step2_5" || completedSteps.step2_5) && (
                    <div
                      id="step2_5"
                      className={`bg-gray-50 rounded-lg p-6 ${
                        currentStep !== "step2_5" && completedSteps.step2_5 ? "opacity-70" : ""
                      }`}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-medium">Step 2-5: 프로필 설정 완성하기</h3>
                        {completedSteps.step2_5 && (
                          <Badge variant="outline" className="bg-green-50 text-green-600 border-green-200">
                            완료
                          </Badge>
                          ...
                          <div className="space-y-4">
                            <div className="mt-2 p-4 bg-gray-50 rounded text-sm">
                              ...
                              <p className="italic text-gray-600">
                                "안녕하세요! 일상과 후기 중심의 블로그입니다 ✨ 맛집, 뷰티 제품, 여행 등 다양한 경험을 정직하고 솔직하게 기록하고
                                공유합니다. 유튜브, 인스타그램, 틱톡 등 다양한 플랫폼에서도 여러분과 소통하고 있어요! 😊 📱 Instagram: @your_instagram
                                🎥 YouTube: (채널명) ✨ TikTok: @your_tiktok ✉️ 협찬/제휴 문의: example@email.com"
                              </p>
                            </div>
                  ...
                  {/* Step 3-1: 카테고리 구성 - 방법 */}
                  {(currentStep === "step3_1" || completedSteps.step3_1) && (
                    <div
                      id="step3_1"
                      className={`bg-gray-50 rounded-lg p-6 ${
                        currentStep !== "step3_1" && completedSteps.step3_1 ? "opacity-70" : ""
                      }`}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-medium">Step 3-1: 카테고리 구성 방법</h3>
                        {completedSteps.step3_1 && (
                          <Badge variant="outline" className="bg-green-50 text-green-600 border-green-200">
                            완료
                          </Badge>
                        )}
                  ...
                  {/* Step 3-2: 카테고리 구성 - TIP */}
                  {(currentStep === "step3_2" || completedSteps.step3_2) && (
                    <div
                      id="step3_2"
                      className={`bg-gray-50 rounded-lg p-6 ${
                        currentStep !== "step3_2" && completedSteps.step3_2 ? "opacity-70" : ""
                      }`}
                    >
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-medium">Step 3-2: 카테고리 설정 TIP</h3>
                        {completedSteps.step3_2 && (
                          <Badge variant="outline" className="bg-green-50 text-green-600 border-green-200">
                            완료
                          </Badge>
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                              <ul className="space-y-2 text-sm text-gray-600">
                                <li className="flex items-start">
                                  <CheckCircle className="h-4 w-4 text-primary mr-2 mt-1 flex-shrink-0" />
                                  <span>
                                    주제별로 명확하게 구분하여 <span className="text-primary font-medium">방문자가 찾기 쉽게</span> 구성하기
                                  </span>
                                </li>
                                <li className="flex items-start">
                                  <CheckCircle className="h-4 w-4 text-primary mr-2 mt-1 flex-shrink-0" />
                                  <span>
                                    너무 많은 카테고리는 피하고, <span className="text-primary font-medium">핵심 주제 중심</span>으로 설정
                                  </span>
                                </li>
                                <li className="flex items-start">
                                  <CheckCircle className="h-4 w-4 text-primary mr-2 mt-1 flex-shrink-0" />
                                  <span>
                                    <span className="text-primary font-medium">체험단/협찬 포스팅을 위한 별도 카테고리</span> 만들기
                                  </span>
                                </li>
                                <li className="flex items-start">
                                  <CheckCircle className="h-4 w-4 text-primary mr-2 mt-1 flex-shrink-0" />
                                  <span>
                                    내 주제의 인기 인플루언서 블로그를 벤치마킹하여 효과적인 카테고리 구조 참고하기
                                  </span>
                                </li>
                              </ul>
                            </div>
                  ...
                  {/* 마무리 조언 */}
                  {completedSteps.step3_2 && (
                    <div id="final-tips" className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-6">
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="bg-green-50 p-4 rounded-lg">
                              <p className="text-sm text-green-700">
                                완벽한 시작을 기다리다 보면 시작조차 하지 못할 수 있습니다. 지금 시작하고, 매일 조금씩 발전하는 것이 성공의 비결입니다.
