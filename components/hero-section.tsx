        ...
        <div className="flex flex-col items-center space-y-10 text-center">
          <div className="space-y-8 max-w-4xl mx-auto">
            <h1 className="text-4xl font-bold tracking-wide sm:text-5xl md:text-6xl lg:text-7xl leading-relaxed">
              ...
              <br />
              <span className="inline-block mt-4 bg-gradient-to-r from-purple-600 to-pink-600 text-transparent bg-clip-text">
                6일만에 전문가처럼
              </span>
            </h1>
            <p className="mx-auto max-w-[700px] text-lg md:text-xl text-gray-600 tracking-wide">
              체계적인 일정관리와 6일 완성 커리큘럼으로
              <br className="hidden sm:inline" />
              100% 당첨되는 체험단 리뷰어의 비밀을 알려드립니다
            </p>
          </div>
